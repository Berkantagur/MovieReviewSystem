...
<head>
    ...
    <title>The Godfather | MOVIES</title>
...
<body>
    <header>
        ...
        <div class="contents">
            ...
            <div class="buttons">
                ...
                <a href="comments.php?movie_id=10" id="more">Add Comment <i class="bi bi-chat-dots"></i></a>
            </div>
        </div>
        <section>
            <h4>Popular</h4>
    ...
    <main>
        <section class="info" id="target">
            <img src="" alt="The Godfather" width="320px" height="400px" id="post">
        ...
        <section class="comments">
            ...
            <div class="comments-lists">
                ...
                $movie_id = 10; // The Godfather movie ID
    ...
    <script>
        fetch(json_url).then((Response) => Response.json())
            .then(data => {
                ...
                return element.name === "The Godfather";
            });
