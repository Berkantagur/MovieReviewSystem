...
<head>
    ...
    <title>Doctor Strange | MOVIES</title>
...
<body>
    <header>
        ...
        <div class="contents">
            ...
            <div class="buttons">
                ...
                <a href="comments.php?movie_id=4" id="more">Add Comment <i class="bi bi-chat-dots"></i></a>
            </div>
        </div>
        <section>
            <h4>Popular</h4>
    ...
    <main>
        <section class="info" id="target">
            <img src="" alt="Doctor Strange in the Multiverse of Maddness" width="320px" height="400px" id="post">
            <div class="info-contents">
                <h1>Doctor Strange: In the Multiverse of Maddness</h1>
                <p>Doctor Strange in the Multiverse of Madness is a 2022 American superhero film based on Marvel Comics featuring the character Doctor Strange. Produced by Marvel Studios and distributed by Walt Disney Studios, it is the sequel to Doctor Strange (2016) and the 28th film in the Marvel Cinematic Universe (MCU). The film was directed by Sam Raimi, written by Michael Waldron, and stars Benedict Cumberbatch as Stephen Strange, alongside Elizabeth Olsen, Chiwetel Ejiofor, Benedict Wong, Xochitl Gomez, Michael Stuhlbarg, and Rachel McAdams. Stephen Strange must protect America Chavez (Gomez), a teenager capable of traveling the multiverse, from Wanda Maximoff (Olsen).</p>
                <p>Doctor Strange director and co-writer Scott Derrickson had plans for a sequel by October 2016. He signed to return as director in December 2018, when Cumberbatch was confirmed to return. The film's title was announced in July 2019 along with Olsen's involvement, while Jade Halley Bartlett was hired to write the film that October. Derrickson stepped down as director in January 2020, citing creative differences. Waldron and Raimi joined the following month and started over, adding elements of the horror genre that Raimi had worked with previously and making Wanda the villain of the film, continuing her story from the Disney+ miniseries WandaVision (2021). Filming began in November 2020 in London but was put on hold in January 2021 due to the COVID-19 pandemic.</p>
                <div class="details">
        ...
        <section class="comments">
            ...
            <div class="comments-lists">
                ...
                $movie_id = 4; // Doctor Strange movie ID
                ...
                <div class="comment">
                    ...
                    <div class="comment-content">
                        <h4>Paul Anderson</h4>
                        <p>The Witcher series has done a great job staying faithful to the game and book series. Atmosphere and character development are very good.</p>
                    </div>
                </div>
                <div class="comment">
    ...
    <script>
        fetch(json_url).then((Response) => Response.json())
            .then(data => {
                ...
                return element.name === "Doctor Strange:\n In Multiverse of Madness";
            });
