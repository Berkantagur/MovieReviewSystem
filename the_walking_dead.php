...
<head>
    ...
    <title>The Walking Dead | SERIES</title>
...
<body>
    <header>
        ...
        <div class="contents">
            ...
            <div class="buttons">
                ...
                <a href="comments.php?movie_id=3" id="more">Add Comment <i class="bi bi-chat-dots"></i></a>
            </div>
        </div>
        <section>
            <h4>Popular</h4>
    ...
    <main>
        <section class="info" id="target">
            <img src="" alt="The Walking Dead" width="320px" height="400px" id="post">
            <div class="info-contents">
                <h1>The Walking Dead</h1>
                <p>The Walking Dead is an American post-apocalyptic horror drama television series developed by Frank Darabont, based on the comic book series of the same name by Robert Kirkman, Tony Moore, and Charlie Adlard. Together, the show and the comic book series form the core of The Walking Dead franchise. The series features a large ensemble cast as survivors of a zombie apocalypse trying to stay alive under near-constant threat of attacks from zombies known as "walkers". With the collapse of modern civilization, these survivors must confront other human survivors who have formed groups and communities with their own sets of laws and morals, sometimes leading to open conflict between them. The series is the first television series within The Walking Dead franchise.</p>
                <p>The Walking Dead premiered on October 31, 2010. It was exclusively broadcast on cable channel AMC in the United States and internationally through the Fox Networks Group and Disney+. The series concluded on November 20, 2022, after eleven seasons and 177 episodes. Andrew Lincoln played the lead character of Rick Grimes until his departure from the show in the ninth season. Other long-standing cast members included Norman Reedus, Steven Yeun, Chandler Riggs, Melissa McBride, Lauren Cohan, Danai Gurira, Josh McDermitt, Christian Serratos, Seth Gilliam, Ross Marquand and Jeffrey Dean Morgan. </p>
                <div class="details">
                    <h5>Drama, Horror, Thiller</h5>
                    <h4>2010</h4>
        ...
        <section class="comments">
            ...
            <div class="comments-lists">
                ...
                $movie_id = 3; // The Walking Dead movie ID
    ...
    <script>
        fetch(json_url).then((Response) => Response.json())
            .then(data => {
                ...
                return element.name === "The Walking Dead";
            });
