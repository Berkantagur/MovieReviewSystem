...
<head>
    ...
    <title>Dune: It Begins | MOVIES</title>
...
<body>
    <header>
        ...
        <div class="contents">
            ...
            <div class="buttons">
                ...
                <a href="comments.php?movie_id=1" id="more">Add Comment <i class="bi bi-chat-dots"></i></a>
            </div>
        </div>
        <section>
            <h4>Popular</h4>
    ...
    <main>
        <section class="info" id="target">
            <img src="" alt="Dune: It Begins" width="320px" height="400px" id="post">
            <div class="info-contents">
                <h1>Dune: It Begins</h1>
                <p>Dune (titled onscreen as Dune: Part One) is a 2021 American epic science fiction film directed and co-produced by Denis Villeneuve, who co-wrote the screenplay with Jon Spaihts, and Eric Roth. It is the first of a two-part adaptation of the 1965 novel of the same name by Frank Herbert. Set in the distant future, the film follows Paul Atreides as his family, the noble House Atreides, is thrust into a war for the deadly and inhospitable desert planet Arrakis. The ensemble cast includes Timothée Chalamet, Rebecca Ferguson, Oscar Isaac, Josh Brolin, Stellan Skarsgård, Dave Bautista, Stephen McKinley Henderson, Zendaya, Chang Chen, Sharon Duncan-Brewster, Charlotte Rampling, Jason Momoa, and Javier Bardem.</p>
                <p>The film is the third adaptation of Dune, following David Lynch's 1984 film and John Harrison's 2000 television miniseries. After an unsuccessful attempt by Paramount Pictures to produce a new adaptation, Legendary Pictures acquired the Dune film and television rights in 2016, with Villeneuve signing on as director in February 2017. Production contracts were secured only for the first film, relying on its success before a sequel would be produced. Principal photography took place from March to July 2019 at locations including Budapest, Jordan, Norway, and Abu Dhabi.</p>
                <div class="details">
        ...
        <section class="comments">
            ...
            <div class="comments-lists">
                ...
                $movie_id = 1; // Dune: It Begins movie ID
    ...
    <script>
        fetch(json_url).then((Response) => Response.json())
            .then(data => {
                ...
                return element.name === "Dune: It Begins";
            });
