...
<head>
    ...
    <title>The Witcher | SERIES</title>
...
<body>
    <header>
        ...
        <div class="contents">
            ...
            <div class="buttons">
                ...
                <a href="comments.php?movie_id=2" id="more">Add Comment <i class="bi bi-chat-dots"></i></a>
            </div>
        </div>
        <section>
            <h4>Popular</h4>
    ...
    <main>
        <section class="info" id="target">
            <img src="" alt="The Witcher" width="320px" height="400px" id="post">
            <div class="info-contents">
                <h1>The Witcher</h1>
                <p>The Witcher is a fantasy drama television series created by Lauren Schmidt Hissrich for Netflix. It is based on the book series[a] by Polish writer Andrzej Sapkowski. Set on a fictional, medieval-inspired landmass known as the Continent, The Witcher explores the legend of Geralt of Rivia, Yennefer of Vengerberg and Princess Ciri. It stars Henry Cavill, Anya Chalotra, and Freya Allan.</p>
                <p>first season, consisting of eight episodes, was released on Netflix on December 20, 2019. It was based on The Last Wish and Sword of Destiny, which are collections of short stories that precede the main The Witcher saga. The second season, also consisting of eight episodes and based on the novel Blood of Elves, was released on December 17, 2021. In September 2021, Netflix renewed the series for a third season, which also consists of eight episodes, released in two volumes on June 29 and July 27, 2023. This will be followed by a fourth season, with Liam Hemsworth taking over the role of Geralt of Rivia. In April 2024, the series was renewed for its fifth and final season.</p>
                <p>An animated origin story film, The Witcher: Nightmare of the Wolf, was released on August 23, 2021. A prequel miniseries, The Witcher: Blood Origin, was released on December 25, 2022.</p>
                <div class="details">
                    <h5>Adventure, Drama, Fantasy</h5>
                    <h4>2019</h4>
        ...
        <section class="comments">
            ...
            <div class="comments-lists">
                ...
                $movie_id = 2; // The Witcher movie ID
    ...
    <script>
        fetch(json_url).then((Response) => Response.json())
            .then(data => {
                ...
                return element.name === "The Witcher";
            });
